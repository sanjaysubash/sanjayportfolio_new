  ...
  return (
    <main className="section-shell section-gap">
      <div className="mx-auto max-w-[980px]">
        <h1 className="editorial-title mb-4 text-[clamp(1.8rem,3.6vw,3.4rem)] font-semibold">Custom High-Performance Workstation Build</h1>
        <p className="muted-copy mb-6 text-lg text-black/75">
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          <div>
            ...
            <h3 className="mt-6 font-semibold">Tech / Hardware Stack</h3>
            <ul className="mt-3 list-disc pl-5 text-black/75">
          ...
          <div>
            <h3 className="font-semibold mb-3">Build Gallery</h3>
